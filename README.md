...
**Rust ML runtime for Apple Silicon — 77x decode speedup, 5.1% gap to MLX**
...
RMLX reimplements Apple's [MLX](https://github.com/ml-explore/mlx) Metal GPU pipeline **entirely in Rust**. The 9-dispatch decode path achieves **1,411 us/layer (77x speedup)** — only **5.1% behind MLX compiled** (1,342 us) on identical hardware.
...
- **9-dispatch decode**: merged QKV/gate-up weights, batched SDPA, single-encoder + memory barriers

...
>
> 상태: 전 Phase 완료 (0-9B-opt + S1-S5 + Phase KO + Audit Remediation) (1,142+ tests, 0 failures) | 라이선스: MIT | Rust 1.80+ | macOS (Apple Silicon)
...
Phase KO 결과: ~109ms/layer → ~1.4ms/layer (77x 속도 향상, MLX 대비 5.1% 격차)
...
6. **ExecGraph CB 배칭**
   ...
   MLX compiled 성능과의 격차 5.1% 이내에서 77x 속도 향상(~109ms → ~1.4ms)을 달성합니다.

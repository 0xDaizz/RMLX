...
>
> 상태: Phase 0 (Foundation) 구현 중 | 라이선스: MIT OR Apache-2.0 | Rust 1.80+ | macOS (Apple Silicon)
...
│   ├── rmlx-core/           # 연산 엔진 (Op registry, Compute graph)
│   ├── rmlx-distributed/    # 분산 프리미티브 (EP, AllReduce)

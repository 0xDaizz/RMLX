...
| GEMM TFLOPS | — | 21.54T (rmlx) vs 23.97T (MLX) | -10% 격차 (Phase B) |

GEMM 처리량 격차는 Phase B config sweep을 통해 13T에서 21.54T TFLOPS로 좁혀졌습니다 (MLX: 23.97T, -10.1% 격차). 잔여 차이는 구성 수준이 아닌 커널 수준(로드 패턴, 저장 경로)입니다.
...
### MLX 비교 (hwstudio1, M=2048, K=4096, N=14336, f16)

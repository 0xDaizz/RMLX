...
|-------------------|-----------|---------------------|
| MHA | `num_kv_heads == num_heads` | legacy dense models |
...
Provides 3 full Transformer model architectures as `TransformerConfig` with complete forward implementations.

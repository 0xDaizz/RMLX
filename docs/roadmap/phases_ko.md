...
MLX 대비 레이어당 디코드 성능 격차를 해소합니다. 디코드 레이턴시를 109,215us(연산별 동기화 베이스라인)에서 MLX 컴파일 경로(2,513 us/L (60L)) 대비 비교 불가 (2.09x 빠름) 수준으로 줄입니다.
...
MLX 컴파일:                   2,513 us/L (60L)  --
MLX 대비 격차:                2.09x 빠름 (60L)
```
